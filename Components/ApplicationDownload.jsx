    ...
    <>
      ...
      >
        <div className="absolute z-10 left-5 bottom-10">
          <img
            className="w-96"
            src="https://ahrominvest.ir/page/advertise-2.png"
            alt=""
          />
        </div>
        <div className="border rounded-xl border-slate-300 w-full h-full ps-28 pe-10 flex justify-between">
          <div className="py-10 flex space-x-reverse space-x-12">
            <div className="border rounded-xl border-slate-300 pt-2 pb-1 px-2 space-y-1">
              <div>
                <img
              ...
              <div>
                <p className="text-xs font-black flex justify-center">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <p className="text-xl font-extrabold">سرمایه‌گذاری اهرم</p>
                <p className="text-lg font-medium">
                  سریع و مطمئن سرمایه‌گذاری کنید.
                </p>
              </div>
              ...
              >
                <div>
                  <p className="text-blue-500 text-lg">مشاهده لینک‌های دانلود</p>
                </div>
                <div className="flex items-center justify-center mt-1.5 rotate-90">
                  <svg
      ...
      <section
        id="recommend_download_app_section"
        className="fixed bottom-0 z-50 w-full bg-ahrom hidden rounded-t-xl items-center px-4"
      >
          ...
          >
            ...
            <div className="flex items-center">
              <p className="text-white font-extrabold">
                دانلود اپلیکیشن سرمایه‌گذاری اهرم
              </p>
            </div>
          </a>
          <div
            id="recommend_download_app_close_btn"
