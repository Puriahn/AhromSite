  ...
  return (
    <li className="group relative cursor-pointer">
      <div
        ...
        className="flex"
      >
        <p className="menu-hover">صندوق</p>
        <span
          className={
            isHover
      ...
      <div
        onMouseEnter={handleHover}
        onMouseLeave={handleLeft}
        className="invisible absolute z-50 flex w-64 rounded-md flex-col bg-white py-1 px-1 text-gray-800 shadow-xl group-hover:visible"
      >
        <Link
          href="/"
