...
export default function OfCanQarardad() {
  ...
  return (
    <div
      className={`${
        showStatus === "qarardad" ? "translate-y-0 " : "translate-y-full "
      } ${cssClass}`}
    >
      {" "}
      <div className="bg-white border-b flex justify-between py-2 px-4 rounded-t-xl">
        <p>قرارداد دریافت اعتبار</p>
        <div onClick={()=>handleMarahel('etelaat')} id="creditConfirmTermsMobileCloseButton" className="flex items-center">
          <svg
      ...
      <div className="bg-white h-full pb-10 overflow-auto no-scrollbar">
        <div className="p-3">
