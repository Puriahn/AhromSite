...
export const data = [
  {
    id: 0,
    q: "صندوق طلا  برای چه کسانی مناسب است؟",
    a: " صندوق طلا یک صندوق ارز دیجیتال مبتنی بر طلا می‌باشد و برای افرادی که قصد سرمایه‌گذاری در طلا را دارند مناسب است.",
    open: false,
  },
  {
    id: 1,
    q: "  بازدهی صندوق طلا  چقدر می‌باشد؟",
    a: "صندوق طلا یک صندوق با سرمایه‌گذاری در طلا می‌باشد. هم‌چنین بازدهی یکساله صندوق طلا، - می‌باشد.",
    open: false,
  },
  {
    id: 2,
  ...
  {
    id: 3,
    q: " صندوق طلا  از چه دارایی‌هایی تشکیل شده است؟",
    a: (
      <p className="inline-block">
                    برای مشاهده ترکیب دارایی صندوق طلا  به صفحه 
