    ...
    <div className="my-2 grid grid-cols-2 sm:grid-cols-4 gap-4 sm:my-8">
      <div className="px-4 py-5 bg-gray-50 rounded-lg">
        ...
        <div className=" space-y-3">
          <h3 className="text-slate-900 font-bold text-16">قیمت خرید</h3>
          <p className="text-slate-900 text-xl">۲۵,۰۸۰ تومان</p>
        </div>
      </div>
      <div className="px-4 py-5 bg-gray-50 rounded-lg">
        <div className="w-12 h-12 flex mb-6 items-center justify-center bg-ahrom rounded-full">
        ...
        <div className=" space-y-3">
          <h3 className="text-slate-900 font-bold text-16">قیمت فروش</h3>
          <p className="text-slate-900 text-xl">۲۴,۹۰۳ تومان</p>
        </div>
      </div>
      <div className="px-4 py-5 bg-gray-50 rounded-lg">
        <div className="w-12 h-12 flex mb-6 items-center justify-center bg-ahrom rounded-full">
        ...
        <div className=" space-y-3">
          <h3 className="text-slate-900 font-bold text-16">دارایی صندوق</h3>
          <p className="text-slate-900 text-xl">۲,۴۵۰,۴۹۱,۵۶۰ تومان</p>
        </div>
      </div>
      <div className="px-4 py-5 bg-gray-50 rounded-lg">
        <div className="w-12 h-12 flex mb-6 items-center justify-center bg-ahrom rounded-full">
        ...
        <div className=" space-y-3">
          <h3 className="text-slate-900 font-bold text-16">بازدهی از ابتدا</h3>
          <p dir="ltr" className="font-medium font-16 text-right text-green-800">
            ۱۵۰.۸۰ %
          </p>
        </div>
      </div>
