...
export const data = [
  {
    id: 0,
    q: "صندوق زمرد برای چه کسانی مناسب است؟",
    a: " صندوق زمرد یک صندوق ارز دیجیتال کم ریسک می‌باشد و برای افرادی که ریسک پذیری بالایی ندارند مناسب است.",
    open: false,
  },
  {
    id: 1,
    q: "بازدهی صندوق زمرد چقدر می‌باشد؟",
    a: "صندوق زمرد یک صندوق با کسب بازدهی حداقلی و مطمئن از ارزهای دیجیتال می‌باشد. هم‌چنین بازدهی یکساله صندوق زمرد، ۴۹.۲۰ % می‌باشد.",
    open: false,
  },
  {
    id: 2,
  ...
  {
    id: 3,
    q: "صندوق زمرد از چه دارایی‌هایی تشکیل شده است؟",
    a: (
      <p className="inline-block">
        برای مشاهده ترکیب دارایی صندوق زمرد به صفحه
