    ...
    <div className="relative pt-[7.5rem] bg-gray-50">
      ...
      >
        <div className="z-10 py-20 pt-28 sm:py-24 sm:pt-40 lg:py-32">
          ...
          صندوق ارز دیجیتال<span className="text-ahrom pr-2"  style={{lineHeight: '2'}} > یاقوت</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-center text-xl text-slate-900 lg:mx-0 lg:text-right">
          صندوق یاقوت یک صندوق ارز دیجیتال با ریسک پذیری بالا می‌باشد و برای افرادی که قصد کسب بازدهی حداکثری را دارند مناسب است.
                    </p>
        ...
        <div className="hidden lg:block">
          <img
            src="https://ahrominvest.ir/home/img/card/3.png"
            className="h-52 w-52"
