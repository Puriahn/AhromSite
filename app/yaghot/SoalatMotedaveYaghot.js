...
export const data = [
  {
    id: 0,
    q: "صندوق یاقوت برای چه کسانی مناسب است؟",
    a: " صندوق یاقوت یک صندوق ارز دیجیتال با ریسک پذیری بالا می‌باشد و برای افرادی که قصد کسب بازدهی حداکثری را دارند مناسب است.",
    open: false,
  },
  {
    id: 1,
    q: "  بازدهی صندوق یاقوت چقدر می‌باشد؟",
    a: " صندوق یاقوت یک صندوق با کسب بازدهی حداکثری از ارزهای دیجیتال می‌باشد. هم‌چنین بازدهی یکساله صندوق یاقوت، ۷۷.۹۴ % می‌باشد.",
    open: false,
  },
  {
    id: 2,
  ...
  {
    id: 3,
    q: " صندوق یاقوت از چه دارایی‌هایی تشکیل شده است؟",
    a: (
      <p className="inline-block">
        برای مشاهده ترکیب دارایی صندوق یاقوت به صفحه
