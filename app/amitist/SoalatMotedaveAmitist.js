...
export const data = [
  {
    id: 0,
    q: "صندوق آمیتیست  برای چه کسانی مناسب است؟",
    a: " صندوق آمیتیست یک صندوق ارز دیجیتال تشکیل شده از دارایی‌های دیفای (غیر متمرکز) می‌باشد و برای افرادی که قصد سرمایه‌گذاری در این گروه را دارند مناسب است.",
    open: false,
  },
  {
    id: 2,
  ...
  {
    id: 3,
    q: " صندوق آمیتیست از چه دارایی‌هایی تشکیل شده است؟",
    a: (
      <p class="inline-block">
                    برای مشاهده ترکیب دارایی صندوق آمیتیست به صفحه 
